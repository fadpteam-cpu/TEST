...
(function(){
  ...
  bar.innerHTML = '<p>This site uses only essential cookies for the page to work and to load fonts. It does not track you. <a href="' + (document.body.dataset.base||'') + 'privacy/">Read our privacy notice</a>.</p>' +
